...
function App() {
  ...
  // Chỉ giữ lại một view, tạm gọi là 'orders' (bao gồm cả báo cáo/tổng hợp)
  const [currentView, setCurrentView] = useState('orders'); 

  // =================================================================
  // STATE CHO TAB ORDER (Tạo Đơn & Danh sách)
  // =================================================================
  ...
  const handleExport = ({ data, headers, filename }) => { 
      const orderedData = data.map(row => { 
          const newRow = {}; 
          headers.forEach(header => { if (header.key) { newRow[header.label] = row[header.key]; } }); 
          return newRow; 
      });
  ...
  const staffSummaryExportHeaders = [ 
      { label: "Nhân Sự", key: "ten_nhansu"}, 
      { label: "Brand", key: "ten_brand" }, 
      { label: "Sản Phẩm", key: "ten_san_pham" }, 
      { label: "Tổng Số Lượng", key: "total_quantity" } 
  ];
  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      {/* --- NÚT CHUYỂN TAB (ĐÃ ĐƠN GIẢN HÓA) --- */}
      <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
          <button 
              ...
              style={{ 
                  padding: '10px 20px', 
                  fontSize: '16px', 
                  cursor: 'default', // Không cho click vì luôn ở đây
              ...
              disabled={true}
          >
              Quản Lý Order & Báo Cáo
          </button>
      </div>

      {/* --- GIAO DIỆN CHÍNH (ORDER + BÁO CÁO) --- */}
      {currentView === 'orders' && (
          <> 
