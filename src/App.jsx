...
function App() {
  ...
  const [contractData, setContractData] = useState({
        ...
        // Bên A là hằng số
        benA_ten: "CÔNG TY TNHH ĐỘNG HỌC STELLA",
  ...
  const handleGenerateContract = (event) => {
    ...
    const contractTemplate = `
        <style>
            ...
            #contractContent h1, #contractContent h2 {
                text-align: center;
                font-weight: bold;
            }
  ...
  // Hàm handleExportAll, handleUpdate, v.v. (Giữ nguyên)
  ...
  // (Form Booking Submit cũ đã bị xóa vì thay bằng Contract)
  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
          ...
          <button 
              ...
              style={{ 
                  ...
                  cursor: 'pointer',
                  backgroundColor: currentView === 'contract' ? // Đổi check thành 'contract'
              '#007bff' : '#f8f9fa',
                  color: currentView === 'contract' ? // Đổi check thành 'contract'
              'white' : 'black',
                  border: '1px solid #dee2e6',
                  borderRadius: '5px'
              }}
      ...
      {/* --- GIAO DIỆN TAB TẠO HỢP ĐỒNG (KHÔI PHỤC) --- */}
      {currentView === 'contract' && (
          <div className="container mx-auto p-4 max-w-7xl" style={{fontFamily: 'Inter, sans-serif'}}>
              <header className="text-center mb-8">
                  <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">Công Cụ Tạo Hợp Đồng Dịch Vụ Quảng Cáo</h1>
                  <p className="mt-2 text-gray-600">Điền thông tin vào biểu mẫu bên dưới để tạo hợp đồng ngay lập tức.</p>
              </header>

              <main className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  {/* CỘT ĐIỀN THÔNG TIN */}
                  <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                      <h2 className="text-2xl font-semibold mb-6 border-b pb-3">Thông tin hợp đồng</h2>
                      <form onSubmit={handleGenerateContract} className="space-y-4">
                          
                          {/* Thông tin Bên A */}
                          <fieldset className="border p-4 rounded-lg">
                              <legend className="px-2 font-semibold text-lg">Bên A (Công ty)</legend>
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                                 <div className="sm:col-span-2">
                                      <label htmlFor="benA_ten" className="block text-sm font-medium text-gray-700">Tên công ty</label>
                                      <input type="text" id="benA_ten" onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value={contractData.benA_ten} readOnly />
                                  </div>
                                  <div className="sm:col-span-2">
                                      <label htmlFor="benA_diaChi" className="block text-sm font-medium text-gray-700">Địa chỉ</label>
                                      <input type="text" id="benA_diaChi" onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value={contractData.benA_diaChi} readOnly />
                                  </div>
                                  <div>
                                      <label htmlFor="benA_mst" className="block text-sm font-medium text-gray-700">Mã số thuế</label>
                                      <input type="text" id="benA_mst" onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value={contractData.benA_mst} readOnly />
                                  </div>
                                  <div>
                                      <label htmlFor="benA_nguoiDaiDien" className="block text-sm font-medium text-gray-700">Người đại diện</label>
                                      <input type="text" id="benA_nguoiDaiDien" onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value={contractData.benA_nguoiDaiDien} readOnly />
                                  </div>
                                  <div>
                                      <label htmlFor="benA_chucVu" className="block text-sm font-medium text-gray-700">Chức vụ</label>
                                      <input type="text" id="benA_chucVu" onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value={contractData.benA_chucVu} readOnly />
                                  </div>
                              </div>
                          </fieldset>
                          ...
                          {/* Thông tin Bên B */}
                          <fieldset className="border p-4 rounded-lg">
                              <legend className="px-2 font-semibold text-lg">Bên B (Người cung cấp dịch vụ)</legend>
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                                  <div>
                                      <label htmlFor="benB_ten" className="block text-sm font-medium text-gray-700">Họ và Tên</label>
                                      <input type="text" id="benB_ten" value={contractData.benB_ten} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: MAI TIẾN LÂM" required />
                                  </div>
                                  <div>
                                      <label htmlFor="benB_sdt" className="block text-sm font-medium text-gray-700">Số điện thoại</label>
                                      <input type="text" id="benB_sdt" value={contractData.benB_sdt} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: 03379726769" required />
                                  </div>
                                  <div className="sm:col-span-2">
                                      <label htmlFor="benB_diaChi" className="block text-sm font-medium text-gray-700">Địa chỉ</label>
                                      <input type="text" id="benB_diaChi" value={contractData.benB_diaChi} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: Hải Vân, Hải Hậu, Nam Định" required />
                                  </div>
                                  <div>
                                      <label htmlFor="benB_cccd" className="block text-sm font-medium text-gray-700">Số CCCD</label>
                                      <input type="text" id="benB_cccd" value={contractData.benB_cccd} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: 040202012030" required />
                                  </div>
                                  <div>
                                      <label htmlFor="benB_mst" className="block text-sm font-medium text-gray-700">Mã số thuế cá nhân</label>
                                      <input type="text" id="benB_mst" value={contractData.benB_mst} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: 040202012030" />
                                  </div>
                                  <div>
                                      <label htmlFor="benB_stk" className="block text-sm font-medium text-gray-700">Số tài khoản</label>
                                      <input type="number" id="benB_stk" value={contractData.benB_stk} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: 3720021903" required />
                                  </div>
                                  <div>
                                      <label htmlFor="benB_nganHang" className="block text-sm font-medium text-gray-700">Ngân hàng thụ hưởng</label>
                                      <input type="text" id="benB_nganHang" value={contractData.benB_nganHang} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: VIETCOMBANK" required />
                                  </div>
                                  <div className="sm:col-span-2">
                                      <label htmlFor="benB_nguoiThuHuong" className="block text-sm font-medium text-gray-700">Người thụ hưởng</label>
                                      <input type="text" id="benB_nguoiThuHuong" value={contractData.benB_nguoiThuHuong} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: MAI TIEN LAM" required />
                                  </div>
                              </div>
                          </fieldset>
                          ...
                          {/* Chi tiết hợp đồng */}
                          <fieldset className="border p-4 rounded-lg">
                              <legend className="px-2 font-semibold text-lg">Nội dung công việc</legend>
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                                  <div>
                                      <label htmlFor="soHopDong" className="block text-sm font-medium text-gray-700">Số hợp đồng</label>
                                      <input type="text" id="soHopDong" value={contractData.soHopDong} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: 260725/HĐQC/ten-STELLA" required />
                                  </div>
                                  <div>
                                      <label htmlFor="ngayKy" className="block text-sm font-medium text-gray-700">Ngày ký hợp đồng</label>
                                      <input type="date" id="ngayKy" value={contractData.ngayKy} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required />
                                  </div>
                                  <div>
                                      <label htmlFor="ngayThucHien" className="block text-sm font-medium text-gray-700">Ngày đăng video</label>
                                      <input type="date" id="ngayThucHien" value={contractData.ngayThucHien} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required />
                                  </div>
                                  <div>
                                      <label htmlFor="sanPham" className="block text-sm font-medium text-gray-700">Sản phẩm</label>
                                      <input type="text" id="sanPham" value={contractData.sanPham} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: Bodymist - Brand BODYMISS" required />
                                  </div>
                                  <div className="sm:col-span-2">
                                      <label htmlFor="linkSanPham" className="block text-sm font-medium text-gray-700">Link sản phẩm</label>
                                      <input type="text" id="linkSanPham" value={contractData.linkSanPham} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Dán link sản phẩm ở đây" required />
                                  </div>
                                  <div className="sm:col-span-2">
                                      <label htmlFor="linkKenh" className="block text-sm font-medium text-gray-700">Link kênh Tiktok</label>
                                      <input type="text" id="linkKenh" value={contractData.linkKenh} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Dán link kênh Tiktok ở đây" required />
                                  </div>
                                  <div>
                                      <label htmlFor="soLuong" className="block text-sm font-medium text-gray-700">Số lượng video</label>
                                      <input type="number" id="soLuong" value={contractData.soLuong} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" min="1" required />
                                  </div>
                                  <div>
                                      <label htmlFor="donGia" className="block text-sm font-medium text-gray-700">Đơn giá (VNĐ)</label>
                                      <input type="number" id="donGia" value={contractData.donGia} onChange={handleContractFormChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="VD: 2000000" required />
                                  </div>
                              </div>
                          </fieldset>
                  ...
                  <div id="outputContainer" className={`bg-white p-6 rounded-xl shadow-md border border-gray-200 ${isOutputVisible ? '' : 'hidden'}`}>
                      <div className="flex justify-between items-center border-b pb-3 mb-4">
                          <h2 className="text-2xl font-semibold" style={{ fontFamily: 'Inter, sans-serif' }}>Nội dung hợp đồng</h2>
                          <div>
                              <button onClick={handleCopyToClipboard} className="py-2 px-4 text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                  Sao chép
                              </button>
                               <button onClick={() => window.print()} className="ml-2 py-2 px-4 text-sm font-medium rounded-md text-gray-700 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400">
                                  In / PDF
                              </button>
                          </div>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-md overflow-auto" style={{ maxHeight: '80vh' }}>
                      ...
                      <div className={`mt-2 text-sm font-medium ${copyMessage.type === 'success' ? 'text-green-600' : copyMessage.type === 'error' ? 'text-red-600' : 'hidden'}`}>
                          {copyMessage.text}
                      </div>
                  </div>
              </main>
