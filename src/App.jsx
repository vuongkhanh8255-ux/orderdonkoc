...
const BodymissScoutTab = lazy(() => import('./components/BodymissScoutTab'));
...
function App() {
  ...
  const [user, setUser] = useState(() => {
    try {
      ...
      const merged = { ...saved, role: fresh.role, name: fresh.name, staff: fresh.staff, seeAll: fresh.seeAll, seeAllOrders: fresh.seeAllOrders, seeAllReport: fresh.seeAllReport };
    ...
    <AppDataProvider>
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div style={mainContentStyle}>
          ...
          {currentView === 'bodymiss_scout' && <BodymissScoutTab currentUser={user} />}
