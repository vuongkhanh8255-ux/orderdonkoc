...
export const ROLE_VIEWS = {
    admin:      ['stella_dashboard','listed_price','costing','tiktok_orders','shop_analytics','crm','cskh','livestream','dashboard','order','booking_performance','contract','airlinks','booking','data_archive','expense','landing_orders','camp_registration','task_notes'],
