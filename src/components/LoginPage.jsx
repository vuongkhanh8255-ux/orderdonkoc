...
export const ROLE_VIEWS = {
    ...
    cs:         ['crm','cskh','seeding','promo_check','reviews','order','airlinks','expense','task_notes'],
    ...
    abm: ['shop_analytics','shopee_ads_dashboard','crm','cskh','seeding','promo_check','reviews','staff_report','booking_budget','booking_performance','airlinks','data_archive','nhanh_products','expense'],
};
