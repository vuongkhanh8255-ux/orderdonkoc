...
export const ROLE_VIEWS = {
    admin:      ['shop_analytics','overview_report','shopee_ads_dashboard','flash_sale','top_picks','shopee_autoreply','shopee_database','shopee_live_ai','shopee_clip_factory','shopee_livestream','shopee_video','shopee_ads','stella_dashboard','listed_price','costing','tiktok_orders','reviews','crm','cskh','livestream','staff_report','booking_budget','order','koc_blacklist','koc_performance','booking_performance','contract','koc_payment','airlinks','booking_material','booking','koc_hunt','data_archive','nhanh_products','expense','landing_orders','camp_registration','task_notes'],
    ...
    assistant:  ['shop_analytics','overview_report','shopee_ads_dashboard','flash_sale','top_picks','shopee_autoreply','shopee_database','shopee_live_ai','shopee_clip_factory','shopee_livestream','shopee_video','shopee_ads','stella_dashboard','listed_price','tiktok_orders','reviews','crm','cskh','livestream','staff_report','booking_budget','order','koc_performance','booking_performance','contract','koc_payment','airlinks','booking_material','booking','koc_hunt','data_archive','nhanh_products','expense','landing_orders','camp_registration','task_notes'],
    // BOOKING: chỉ Booking group + Ngân Sách Ecom. KHÔNG Ecom group, KHÔNG Task & Notes.
    booking:    ['staff_report','booking_budget','order','koc_performance','booking_performance','contract','koc_payment','airlinks','booking_material','booking','koc_hunt','expense'],
    ...
    ecom:       [
        'stella_dashboard','listed_price','tiktok_orders','shop_analytics','overview_report','shopee_ads_dashboard','flash_sale','top_picks','shopee_autoreply','shopee_database','shopee_live_ai','shopee_clip_factory','shopee_livestream','shopee_video','shopee_ads','camp_registration','reviews', // Ecom + Shopee + Reviews
        'cskh',                                                                // CSKH
        'livestream',                                                          // Livestream
        'staff_report','booking_budget','order','koc_performance','booking_performance','airlinks','booking_material','koc_payment','koc_hunt', // Booking (no Hợp Đồng)
    ...
    abm: ['shop_analytics','shopee_ads_dashboard','crm','cskh','reviews','staff_report','booking_budget','booking_performance','airlinks','data_archive','nhanh_products','expense'],
};
