...
export const ROLE_VIEWS = {
    ...
    cs:         ['crm','cskh','seeding','promo_check','cases','vouchers','defects','daily_report','reviews','order','airlinks','expense','task_notes'],
    ...
    ecom:       [
        ...
        'cskh','seeding','promo_check','cases','vouchers','defects','daily_report',                                                                // CSKH
        'livestream',                                                          // Livestream
        'staff_report','booking_budget','order','koc_performance','booking_performance','airlinks','booking_material','koc_payment','koc_hunt','bodymiss_scout', // Booking (no Hợp Đồng)
    ...
    abm: ['shop_analytics','shopee_ads_dashboard','crm','cskh','seeding','promo_check','cases','vouchers','defects','daily_report','reviews','staff_report','booking_budget','booking_performance','airlinks','data_archive','nhanh_products','expense'],
};
