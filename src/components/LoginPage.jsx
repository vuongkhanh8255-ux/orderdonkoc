...
export const ROLE_VIEWS = {
    ...
    ecom:       [
        ...
        'cskh','seeding','returns','complaints','vouchers','defects',                                                                // CSKH
    ...
    abm: ['shop_analytics','shopee_ads_dashboard','crm','cskh','seeding','returns','complaints','vouchers','defects','reviews','staff_report','booking_budget','booking_performance','airlinks','data_archive','nhanh_products','expense'],
};
