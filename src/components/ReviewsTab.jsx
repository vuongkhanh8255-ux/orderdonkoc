...
const REASON_CATEGORIES = ['Chê sản phẩm', 'Lỗi sản phẩm', 'Kích ứng / Dị ứng', 'Không hiệu quả', 'Giao hàng chậm', 'Sai hàng', 'Thiếu hàng', 'Hư hỏng vận chuyển', 'Đóng gói', 'Shipper', 'Lỗi hệ thống', 'Spam', 'Hiểu nhầm', 'Không nhận xét'];   // + Hư hỏng vận chuyển (CS 1/8), + Lỗi hệ thống (FB 3/8)
