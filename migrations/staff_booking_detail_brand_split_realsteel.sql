-- MERGE 2 nhánh: (a) brand-split của staff_booking_detail_brand_split.sql (1 KOC × 1 brand/dòng,
--   trả brand/last_air/since — frontend KocPerformanceTab đọc mấy field này) + (b) Real Steel = GIAN ĐỘC LẬP.
-- Bổ sung ('REALSTEEL','7496180170889726491') vào brand_map (brand_canon 'REALSTEEL' do asg canonical hoá).
-- Bản này là bản CHUẨN cuối cùng của staff_booking_detail — chạy SAU cả brand_split.sql lẫn realsteel_independent_gian.sql.
